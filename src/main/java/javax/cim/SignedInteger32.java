...
/**
 * This class represents an <code>SignedInteger32</code>. A
 * <code>sint32</code> data type is defined by the (<a
 ...
 * >DSP004</a>).
 */
public class SignedInteger32 extends Number implements Comparable<SignedInteger32> {

	private static final long serialVersionUID = 246233176793838916L;

	/**
	 * The maximum value for an <code>SignedInteger32</code>.
	 */
	public static final long MAX_VALUE = 4294967295l;

	/**
	 * The minimum value for an <code>SignedInteger32</code>.
	 */
	public static final long MIN_VALUE = -4294967295l;
	...
	private void setValue(long pValue) throws NumberFormatException {
		if (pValue > MAX_VALUE || pValue < MIN_VALUE) {
			String msg = "sint32:" + pValue + " is out of range!";
	...
	/**
	 * Constructs an signed 32-bit integer object for the specified long
	 * value. Only the lower 32 bits are considered.
	 * 
	 * @param pValue
	 *            The long to be represented as an signed 32-bit integer.
	 * @throws NumberFormatException
	 *             If the number is out of range.
	 */
	public SignedInteger32(long pValue) throws NumberFormatException {
		setValue(pValue);
	}

	/**
	 * Constructs an signed 32-bit integer object for the specified string.
	 * Only the lower 32 bits are considered.
	 * 
	 * @param pValue
	 *            The string to be represented as an signed 32-bit integer.
	 * @throws NumberFormatException
	 *             If the number is out of range.
	 * @throws IllegalArgumentException
	 *             If value is <code>null</code>.
	 */
	public SignedInteger32(String pValue) throws NumberFormatException {
	 ...
	 *             If value is <code>null</code>.
	 */
	public int compareTo(SignedInteger32 pOther) {
		if (pOther == null) throw new IllegalArgumentException(
				"Other SignedInteger32 cannot be null!");
		SignedInteger32 that = pOther;
	 ...
	 * SignedInteger32 object that represents the same value as this object.
	 * 
	 * @param pObj
	...
	public boolean equals(Object pObj) {
		if (!(pObj instanceof SignedInteger32)) return false;
		return this.iValue == ((SignedInteger32) pObj).iValue;
	}
